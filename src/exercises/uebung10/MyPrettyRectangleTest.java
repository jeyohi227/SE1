...
public class MyPrettyRectangleTest {
    ...
    public void testContains() {
        ...
        // [ihr Code]
        assertFalse(  left.contains(middle) );
    ...
    public void testGetCenter(){
        ...
        // Fuer einen korrekten Vergleich der MyPoint-Objekte sollten sie die Methode equals entsprechend ueberschreiben
    ...
    public void testSameIdentity() {
        ...
        assertTrue(!right.equals(somewhere));
        assertTrue(!middle.equals(somewhere));
    ...
    public void testGetBoundingBox( ) {
        ...
        /*                  x1,  y1,  x2,  y2
         *       middle   (2.0, 2.0, 3.0, 3.0)
         *       right    (1.0, 0.0, 4.0, 4.0)
         *       somewhere(5.0, 1.0, 6.0, 4.0)
         */

        assertEquals( new MyPrettyRectangle(1.0,0.0,6.0,4.0), BoundingBoxFactory.boundingBox(rect));
